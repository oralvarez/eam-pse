# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-05-09 23:50
...
class Migration(migrations.Migration):
    ...
    replaces = [(b'transacciones', '0001_initial')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ciudad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.Ciudad')),
            ],
        ),
        migrations.CreateModel(
            name='Departamento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localizacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.Localizacion')),
                ('moneda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.Moneda')),
            ],
        ),
        migrations.CreateModel(
            name='TipoContrato',
        ...
        migrations.AddField(
            model_name='producto',
            name='tipo_contrato',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.TipoContrato'),
        ),
        migrations.AddField(
            model_name='producto',
            name='tipo_ubicacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.TipoUbicacion'),
        ),
        migrations.AddField(
            model_name='producto',
            name='usuario',
        ...
        migrations.AddField(
            model_name='moneda',
            name='pais',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.Pais'),
        ),
        migrations.AddField(
            model_name='localizacion',
            name='tipo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.TipoObjeto'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='ciudad',
            name='departamento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='transacciones.Departamento'),
        ),
    ]
